...
from fastchat.model.model_adapter import add_model_args  # see [model_adapter.py](model_adapter.py)
from fastchat.serve.inference import chat_loop, ChatIO  # see [inference.py](inference.py)
